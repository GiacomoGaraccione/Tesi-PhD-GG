...
Answers to the two open questions were instead analyzed with an \textit{open coding} approach (see Section \ref{sec:empirical_methods})\cite{strauss1998basics} with a two-iteration procedure: after identifying topics across all answers, answers were analyzed again to identify a potentially more relevant to assign them out of the set. 
