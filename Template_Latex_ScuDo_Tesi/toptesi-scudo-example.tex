...
The gamification aspects of the research are grounded in four empirical studies performed with two tools developed throughout the first years of the PhD. One of them, named BIPMIN and focused on gamifying BPMN modeling, was first assessed with a preliminary usability evaluation and then used in a controlled experiment with students of a Masters level course. The findings from the experiment led to the definition of a generalized gamification framework that then guided the development of UMLegend, a tool that supports UML class diagram assignments that was then evaluated with a second controlled experiment, following the same design as the first one. The BIPMIN tool was then redesigned according to the framework and adopted for a longitudinal study through the 2023-2024 edition of an Information Systems course, tracking the impact of the game mechanics on modeling performance over five progressive exercises and through grade comparison with the preceding non-gamified cohort.
